...
// 	t_node	*node_node;
// 	t_node	*node_new_node1;
// 	t_node	*node_new_node2;
// 	t_node	**node;

// 	node = &node_node;
// 	node_node = ft_lstnew(content_node);
// 	node_new_node1 = ft_lstnew(content_new_node_1);
// 	node_new_node2 = ft_lstnew(content_new_node_2);
// 	ft_lstadd_back(node, node_new_node1);
// 	ft_lstadd_back(node, node_new_node2);
